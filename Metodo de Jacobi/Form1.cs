...
namespace Metodo_de_Jacobi {
    public partial class Form1 : Form {
        ...
        private void btnCalcular_Click(object sender, EventArgs e) {
            calcularMetodoJacobi();
        }

        public void calcularMetodoJacobi() {
            try {
            ...
            for (; condicion && x < 50; x++) {
                misValores[x + 1, 0] = evaluarDespejeFuncion1(misValores[x, 1], misValores[x, 2]);
                misValores[x + 1, 1] = evaluarDespejeFuncion2(misValores[x, 0], misValores[x, 2]);
                misValores[x + 1, 2] = evaluarDespejeFuncion3(misValores[x, 0], misValores[x, 1]);
