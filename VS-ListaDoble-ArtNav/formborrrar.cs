...
namespace VS_ListaDoble_ArtNav {
    public partial class formborrrar : Form {
        ListaDoble<FabricaArticulosNavidenios> miLista = new ListaDoble<FabricaArticulosNavidenios>();
        ...
        private void Mostrar() {
            ...
            foreach (FabricaArticulosNavidenios f in miLista.HaciaAdelante) {
                ...
                dataGridView1.Rows.Add(f.Nombre, f.TamanioTerritorio, f.Clasificacion, f.FechaInauguracion.ToString("dd/MM/yy"), f.TieneCredito ? "Si" : "No",
        ...
        private void btnEliminarTodo_Click(object sender, EventArgs e) {
            ...
            Mostrar(); Acciones(); pictureBox1.Image = null;
        }
        ...
        private void btnEliminarSeleccionado_Click(object sender, EventArgs e) {
            ...
            if (MessageBox.Show("Esta seguro que desea eliminar la fabrica:\n" + fabricaAux.Nombre, "Confirmacion", MessageBoxButtons.YesNo) == DialogResult.Yes) {
                ...
                MessageBox.Show(fabricaAux != null ? "Se elimino la fabrica con datos:" + fabricaAux.ToString() : "No se elimino la fabrica");
            } else {
